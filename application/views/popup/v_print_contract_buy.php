...
<html>
	...
	<body style="">
		...
		<div style="text-align: center;margin-top: -20px"><h5>ជាតិ សាសនា ព្រះមហាក្សត្រ</h5></div>
		<div style="text-align: center;margin-top: -30px"><span style='font-size:30px;'>&#10037;</span></div>
		<div style="text-align: center;margin-top: -30px"><h5>កិច្ចសន្យាទិញ-លក់ផ្ទះ</h5></div>
		<div style="text-align: left;"><h5>កិច្ចសន្យានេះធ្វើឡើងរវាង</h5></div>
		...
		<div style="text-align: center;margin-top: -10px"><h5>និង</h5></div>
		...
		<div style="text-align: center;margin-top: -10px"><h5>បុព្វកថា</h5></div>
		<div style="margin-top: -10px">
			<p style="font-size: 12px;">
				ដោយ <b>ភាគី”ក”</b>  ជាម្ចាស់សំណង់ ក្រុមហ៊ុន <b>ហ្គាឡាក់ស៊ី១១</b> សម្រាប់ លក់ជូនអតិថិជនជា ភាគី”ខ” មានបំណងចង់ទិញផ្ទះ ភាគី”ក”។
			</p>
		</div>
		<div style="text-align: center;margin-top: -10px"><h5>ភាគីទាំងពីរឯកភាពតាមប្រការដូចខាងក្រោមៈ</h5></div>
		
		<div style="text-align: left;margin-top: -10px"><h5><u>ប្រការ ១៖</u>	<span style="margin-left: 30px"> ទំហំដី និង ផ្ទះ</span></h5></div>
		...
		<div style="text-align: left;margin-top: -10px"><h5><u>ប្រការ ២៖</u>	<span style="margin-left: 30px"> តម្លៃផ្ទះ</span></h5></div>
		...
		<div style="text-align: left;margin-top: -10px"><h5><u>ប្រការ ៣៖</u>	<span style="margin-left: 30px"> ការទូទាត់ប្រាក់</span></h5></div>
		...
		<div style="text-align: left;margin-top: -10px"><h5><u>ប្រការ ៤៖</u>	<span style="margin-left: 30px"> សិទ្ធិ និង កាតព្វកិច្ចរបស់ភាគី”ក”</span></h5></div>
		<div style="margin-top: -10px;margin-left: 40px">
			<p style="font-size: 12px;">
