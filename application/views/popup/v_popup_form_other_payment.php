			...
			<div class="row">
				...
				<div class="col-xs-12 row" style="padding:0px">
					...
					<div class="col-xs-4 padding-forms-left">
                        <div class="form-group">
							...
							<select class="form-control" id="cboProCode" name ="cboProCode" style="font-size: 14px;" required="required" oninvalid="this.setCustomValidity('​ ​សូមជ្រើសរើសលេខកូដផ្ទះ')" oninput="setCustomValidity('')">
            					<option>AAAAA</option>
            				</select>
            	...
            	<div class="col-xs-12 row" style="padding:0px">
            		...
            		<div class="col-xs-4 padding-forms-right">
		                ...
		                <div class="form-group">
				      		<label  for="txtPayAmt" >ប្រាក់ត្រូវបង់ $</label>
				        	<input type="text" class="form-control" id="txtPayAmt" placeholder="Enter loan amount" name="txtPayAmt" autocomplete="off" required="required" />
				    	</div>
                ...
                <div class="col-xs-12 row" style="padding:0px">
            		...
            		<div class="col-xs-4 padding-forms-right">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txtDesc" placeholder="Enter Description" name="txtDesc" autocomplete="off" required="required"/>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 row" style="padding:0px;height: 130px;">
...
<script src="<?php echo base_url('assets/') ?>js/pages/popup/v_popup_form_other_payment.js"></script>