...
<input type="hidden" id="projId" name="projId" value="<?php if(isset($_GET["id"])){ echo $_GET["id"]; }?>"/>
...
<!-- form start -->
<div role="form" class="form-horizontal" id="frmProject" action="" style="display: none">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btnExit">
			...
			<h4 class="modal-title" id="popupTitle">
				...
				<span data-i18ncd="pop_select_project">Select Project</span>
			</h4>
	</div>
	...
	<div class="modal-body" id="modalMdBody">
		...
		<div class="row">
			...
			<!-- /.button -->
			<br>
			<div class="box-body table-responsive fix-header-tbl" style="height: 348px;">
				<table class="table table-hover" id="tblProject" >
					<thead>
					<tr>
						<th><input type="checkbox" id="chkAllProject" style="display: none;"></th>
...
<script src="<?php echo base_url('assets/') ?>js/pages/popup/v_popup_select_project.js"></script>
