<?php include 'v_popup_header.php';?>
	  ...
	  <input type="hidden" id="imp_id" name="imp_id" value="<?php if(isset($_GET["id"])){ echo $_GET["id"]; }?>"/>
...
<script src="<?php echo base_url('assets/') ?>js/pages/popup/v_popup_form_import.js"></script>
