...
<html>
	...
	<body style="">
		...
		<div style="margin-top: -10px">
			...
			<?php if($OUT_REC[2]->cus_nm_kh != "" && $OUT_REC[2]->cus_nm_kh != null){ ?>
			    
    			   និង  ឈ្មោះ  <?php echo $OUT_REC[2]->cus_nm_kh;?> ភេទ  <?php 	if($OUT_REC[2]->cus_gender=="Male"){echo "ប្រុស";}else if($OUT_REC[2]->cus_gender=="Female"){echo "ស្រី";}?> កាន់អត្តសញ្ញាណប័ណ្ណលេខ <?php echo $OUT_REC[2]->cus_idnt_num;?>  ចុះថ្ងៃទី <?php echo substr($OUT_REC[2]->cus_indt_date,8,2);?> ខែ <?php echo substr($OUT_REC[2]->cus_indt_date,5,2);?> ឆ្នាំ <?php echo substr($OUT_REC[2]->cus_indt_date,0,4);?>  អាស័យដ្ឋាន <?php echo $OUT_REC[2]->cus_addr;?> ជាអ្នកទិញ ហៅកាត់ថា <b>ភាគី “ខ”</b> លេខទូរស័ព្ទទំនាក់ទំនង <?php echo $OUT_REC[0]->cus_phone1;?>      /  <?php echo $OUT_REC[1]->cus_phone1;?> /  <?php echo $OUT_REC[2]->cus_phone1;?>     ។
			<?php }	else{?> ។ </p> <?php }?>
		</div>
...
រយៈពេល  <?php echo $OUT_REC[0]->pro_sell_time_build;?>ខែ គិតពីថ្ងៃចុះកិច្ចសន្យា លើកលែងក្នុងករណីប្រធានស័ក្កដូចជា៖ ទឹកជំនន់ រញ្ជួយដី វិបត្តិនយោបាយ អស្ថេរភាពសង្គមកើតឡើង ដែលហេតុការណ៍ទាំងនេះ បណ្ដាលឲ្យមានការរាំងស្ទះដល់ការសាងសង់ ។
		...
		<div style="margin-top: 100px;">
			<table class="tbl-head">
				...
				<tr>
					<td style="width: 50%;padding-left: 50px;"><h4><?php echo $OUT_REC[0]->cus_nm_kh;?> & <?php echo $OUT_REC[1]->cus_nm_kh;?> & <?php echo $OUT_REC[2]->cus_nm_kh;?></h4></td>
