...
<html>
	...
	<body style="">
		...
		<div style="margin-top: -10px;margin-left: 40px">
			...
			<p style="font-size: 15px;">
				ការទូទាត់អាចនៅការិយាល័យផ្ទាល់   រឺតាមធនាគារវធ្ឍនៈអាស៊ីចំកាត់ (ABA Bank) គណនីឈ្មោះ   <b>Heng Piseth and Mean Tong</b> គណនីលេខ<b>000935494</b> ដែលកំណត់ឡើងដោយក្រុមហ៊ុន <b>ហ្គាឡាក់ស៊ី១១</b>។
			</p>
			<p style="font-size: 15px;">
				<b>បញ្ជាក់ :</b> 
			</p>
			...
			<p style="font-size: 15px;">
				<span style="margin-right: 10px;font-weight: bold;">២.</span>ក្នុងករណី <b>ភាគី”ខ”</b> សិក្សាប្រាក់កម្ចីជាមួយធនាគាមិនជាប់ នោះ <b>ភាគី”ខ”</b> ត្រូវបង់ប្រាក់រំលស់ជាមួយ ក្រុមហ៊ុន <b>ហ្គាឡាក់ស៊ី១១</b> រយះពេល 60ខែ ជាមួយអត្រាការប្រាក់ 1.2% ក្នុងមួយខែ រឺអាចបង់ផ្ដាច់<?php if($OUT_REC[0]->cat_id == "3"){echo "នៅខែទី១៩";}?>។
			</p>
		</div>
